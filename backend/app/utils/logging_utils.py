...
loggers = {
    ...
    "supabase_agent": setup_logger("supabase_agent", "supabase_agent.log"),
    "mcp": setup_logger("mcp_service", "mcp_service.log"),
}


def get_logger(name: str) -> logging.Logger:
    """
    Get a logger by name. If the logger doesn't exist, create a default one.
